...
export default function userApplicationRoutes(app, io, sequelize) {
    ...
    // application payment
    router.post('/applications/:id/pay/application/init', authenticateToken, applicationController.applicationFeeInit);
    router.post('/applications/:id/pay/application', authenticateToken, applicationController.payForApplication);
    router.post('/applications/:id/pay/acceptance/init', authenticateToken, applicationController.acceptanceFeeInit);
